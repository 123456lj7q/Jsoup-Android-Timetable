...
b.ajax({
	...
	success: function(c){
		if(c=="0"){
			b.alert(b.i18n.zftal.statusCode["911"],function(){},{modalName:"statusModal"});
		}else if(c!=null && c!=""){
        	b.alert(c,function(){},{modalName:"statusModal"});
		}else{
        	b.alert(b.i18n.zftal.statusCode["904"],function(){},{modalName:"statusModal"});
		}
	}
})},905:function(){a={};if(b("#statusModal").size()>0){return}b.alert(b.i18n.zftal.statusCode["905"],function(){},{modalName:"statusModal"})},906:function(){a={};if(b("#statusModal").size()>0){return}b.alert(b.i18n.zftal.statusCode["906"],function(){},{modalName:"statusModal"})},907:function(){a={};if(b("#statusModal").size()>0){return}b.alert(b.i18n.zftal.statusCode["907"],function(){},{modalName:"statusModal"})},908:function(){a={};if(b("#statusModal").size()>0){return}b.alert(b.i18n.zftal.statusCode["908"],function(){},{modalName:"statusModal"})},909:function(){a={};if(b("#statusModal").size()>0){return}b.alert(b.i18n.zftal.statusCode["909"],function(){},{modalName:"statusModal"})},910:function(){a={};if(b("#statusModal").size()>0){return}b.alert(b.i18n.zftal.statusCode["910"],function(){},{modalName:"statusModal"})},911:function(){a={};if(b("#statusModal").size()>0){return}b.alert(b.i18n.zftal.statusCode["911"],function(){},{modalName:"statusModal"})}}});b.ajaxPrefilter(function(g,l,i){if(g.abortOnRetry){var k=b.param(l.data||{});var h=b.founded(k)?((g.url||"")+((g.url||"").indexOf("?")>-1?"&":"?")+k):(g.url||"");var f=(typeof b.md5!="undefined")?b.md5(h):h;var d=a[f];if(b.defined(d)){try{if(d.readyState!=4){i.abort();if(console&&console.error){console.error("\u5df2\u5b58\u5728\u4e0e\u5f53\u524d\u8bf7\u6c42\u8def\u5f84\u548c\u53c2\u6570\u76f8\u540c\u7684\u8bf7\u6c42\u4e14\u672a\u5b8c\u6210!")}}else{a[f]=i}}catch(j){delete a[f];console.error(j)}}else{a[f]=i}}});function c(e){if(e.abortOnRetry){var g=b.isPlainObject(e.data)?b.param(e.data||{}):"";var f=b.founded(g)?((e.url||"")+((e.url||"").indexOf("?")>-1?"&":"?")+g):(e.url||"");var d=(typeof b.md5!="undefined")?b.md5(f):f;a[d]=null;delete a[d]}}b(document).ajaxSend(function(e,f,d){if(b.matchURL(d.url)){}else{if(b.defined(d.data)){d.url=b.getURL(d.url,d.data)}else{if(b.defined(d.url)){d.url=b.getURL(d.url,{})}}}}).ajaxError(function(g,i,e){c(e);if(i.status==904&&b("#loading_status").size()>0){var f="\u8bf7\u52ff\u9891\u7e41\u5237\u65b0\u6216\u8005\u70b9\u51fb\u83dc\u5355,\u8bf7<label id='times' data-time='"+_refreshInterval+"'>"+_refreshInterval+"</label>\u79d2\u540e\u518d\u64cd\u4f5c!~";b("#loading_status").replaceWith('<div class="red " style="font-size: 20px;margin-top: 150px;text-align: center;" role="alert"  id="messageTip">'+f+"</div>");var h=parseInt(b("#times").data("time"));var d=window.setInterval(function(){h-=1;if(h<=0){window.clearInterval(d);b("#messageTip").html("\u8bf7\u91cd\u65b0\u5237\u65b0\u9875\u9762\u6216\u8005\u70b9\u51fb\u6309\u94ae!").removeClass("red2").addClass("green")}b("#times").text(h)},1000)}}).ajaxComplete(function(e,f,d){c(d)})})(jQuery);
/*
